...
#  LIBICONV_LIBRARYS     - List of libraries when using libiconv.
...
FIND_LIBRARY(LIBICONV_LIBRARYS iconv)

# handle the QUIETLY and REQUIRED arguments and set Libmemcached_FOUND to TRUE if
# all listed variables are TRUE
INCLUDE(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(LIBICONV DEFAULT_MSG LIBICONV_LIBRARYS LIBICONV_INCLUDE_DIRS)
...
MARK_AS_ADVANCED(LIBICONV_LIBRARYS LIBICONV_INCLUDE_DIRS LIBICONV_CONST)
