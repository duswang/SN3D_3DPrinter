...
typedef enum {
    ...
    APP_EVT_MSG_3D_PRINTER_PAUSE_DONE            = 0x0002,
    APP_EVT_MSG_3D_PRINTER_DEVICE_STOP_DONE      = 0x0003,
    APP_EVT_MSG_3D_PRINTER_PRINTING_FINISH       = 0x0004,
    APP_EVT_MSG_3D_PRINTER_RAMPS_BOARD_INIT_DONE = 0x0005,
